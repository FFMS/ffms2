...
## Copied from cmake-2.6.4 distribution
## Fixed so it checks for static pthreads-win32
...
ELSE(CMAKE_HAVE_SPROC_H)
  ...
  IF(CMAKE_HAVE_PTHREAD_H)
    ...
    IF(NOT THREADS_HAVE_PTHREAD_ARG)
      ...
      # Check for -lpthreadGC2 then
      # Try the dynamically linked one
      CHECK_LIBRARY_EXISTS(pthreadGC2 pthread_create "" CMAKE_HAVE_PTHREADS_CREATE)
      IF(CMAKE_HAVE_PTHREADS_CREATE)
      ...
      # Try the statically linked one
      SET(CMAKE_REQUIRED_DEFINITIONS PTW32_STATIC_LIB)
      CHECK_LIBRARY_EXISTS(pthreadGC2 pthread_create "" CMAKE_HAVE_PTHREADS_CREATE)
      IF(CMAKE_HAVE_PTHREADS_CREATE)
        SET(CMAKE_THREAD_LIBS_INIT "-lpthreadGC2")
        ADD_DEFINITIONS(PTW32_STATIC_LIB)
        SET(CMAKE_HAVE_THREADS_LIBRARY 1)
        SET(Threads_FOUND TRUE)
      ENDIF(CMAKE_HAVE_PTHREADS_CREATE)
